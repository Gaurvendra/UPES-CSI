                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Mail Left</h4>
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <?php $sql = mysql_query("SELECT * FROM `reg` WHERE `sent` = 0 ORDER BY `date` DESC") or die("error"); ?>
                                            <?php
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td style="text-align:center"><?php echo $ro['sap'] ; ?></td>
                                                    ...
                                                    <td style="text-align:center"><?php echo $ro['sent'] ; ?></td>
